...
class Pnet(nn.Module):
    def __init__(self):
        ...
        self.conv2 = nn.Conv2d(in_channels=10,out_channels=16,kernel_size=3,stride=1)# N 16 3 3
        self.conv3 = nn.Conv2d(in_channels=16, out_channels=32, kernel_size=3, stride=1)#N 32 1 1
...
class Rnet(nn.Module):
    def __init__(self):
        ...
        self.conv3 = nn.Conv2d(in_channels=48, out_channels=64, kernel_size=2, stride=1, padding=0)#N 64 3 3
...
class Onet(nn.Module):
    def __init__(self):
        ...
        self.conv4 = nn.Conv2d(in_channels=64, out_channels=128, kernel_size=2, stride=1, padding=0)#N 128 3 3
...
if __name__ == '__main__':
    ...
    torchsummary.summary(model, input_size = (3,24,24), batch_size=-1, device="cuda")
